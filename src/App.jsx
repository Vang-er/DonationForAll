...
export default function MyApp() {
  return (
    <>
      <nav className="bg-green-600 text-white shadow-md">
        <div className="max-w-7xl mx-auto h-16 px-6 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <button className="px-4 py-2 rounded-lg hover:bg-green-700 transition flex items-center gap-1 px-4 py-2">
      ...
      <main className="">
        <div className="pt-15 pl-50 bg-green-100 grid gap-1/2 grid-cols-2">
          <div className="">
        ...
        <div className="max-w-1/4 mt-10">
          <div className="inline tracking-wider">Join<div className="text-green-800 inline"> thousands </div> of donors and charities making a real difference.</div>
        </div>
        </div>
        
        <div className="frame relative w-full max-w-[520px] h-[420px] md:h-[500px] shrink-0 ">
          <div className="grid grid-rows-3 gap-35">
          <div className="font-extrabold flex justify-items-center text-3xl text-center">Some of the Sites' active donations</div>
         <CardCarousel/>
         <div className=" pl-20 mx-auto text-base text-center tracking-wider text-gray-800">From daily essentials to education and emergency <br></br>relif, see how your genrosity is creating real <br></br> change everyday.</div>
         </div>
         </div>
        </div>
